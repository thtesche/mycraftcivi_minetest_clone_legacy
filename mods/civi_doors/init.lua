...
local function is_doors_upper_node(pos)
	return minetest.get_node(pos).name == "civi_doors:hidden"
end
...
minetest.register_node("civi_doors:hidden", {
	...
	minetest.register_lbm({
		...
		action = function(pos, node)
			...
			minetest.set_node({x = pos.x, y = pos.y + 1, z = pos.z},
				{name = "civi_doors:hidden", param2 = p3})
		end
	})
	...
	minetest.register_craftitem(":" .. name, {
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			if minetest.get_item_group(minetest.get_node(aside).name, "door") == 1 then
				...
				minetest.set_node(above, {name = "civi_doors:hidden", param2 = (dir + 3) % 4})
			else
				minetest.set_node(pos, {name = doorname .. "_a", param2 = dir})
				minetest.set_node(above, {name = "civi_doors:hidden", param2 = dir})
			end
...
doors.register_trapdoor("civi_doors:trapdoor", {
...
doors.register_trapdoor("civi_doors:trapdoor_steel", {
...
minetest.register_craft({
	output = "civi_doors:trapdoor_steel",
	recipe = {
		{"default:steel_ingot", "default:steel_ingot"},
		{"default:steel_ingot", "default:steel_ingot"},
	}
...
doors.register_fencegate("civi_doors:gate_wood", {
	description = S("Apple Wood Fence Gate"),
	texture = "civi_wood.png",
	material = "default:wood",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2}
})

doors.register_fencegate("civi_doors:gate_acacia_wood", {
	description = S("Acacia Wood Fence Gate"),
	texture = "civi_acacia_wood.png",
	material = "default:acacia_wood",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2}
})

doors.register_fencegate("civi_doors:gate_junglewood", {
	description = S("Jungle Wood Fence Gate"),
	texture = "civi_junglewood.png",
	material = "default:junglewood",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2}
})

doors.register_fencegate("civi_doors:gate_pine_wood", {
	description = S("Pine Wood Fence Gate"),
	texture = "civi_pine_wood.png",
	material = "default:pine_wood",
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3}
})

doors.register_fencegate("civi_doors:gate_aspen_wood", {
	description = S("Aspen Wood Fence Gate"),
	texture = "civi_aspen_wood.png",
...
minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:trapdoor",
	burntime = 7,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:door_wood",
	burntime = 14,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:gate_wood_closed",
	burntime = 7,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:gate_acacia_wood_closed",
	burntime = 8,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:gate_junglewood_closed",
	burntime = 9,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:gate_pine_wood_closed",
	burntime = 6,
})

minetest.register_craft({
	type = "fuel",
	recipe = "civi_doors:gate_aspen_wood_closed",
	burntime = 5,
})
